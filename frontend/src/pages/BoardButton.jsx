        ...
        <nav className="sidebar p-3 border-end border-secondary border-opacity-25">
          <section className="mb-4">
            ...
            <div className="d-flex flex-column gap-1 mt-3">
              <Link to="/activity" className="sidebar-btn-link">
                <i className="bi bi-list-task me-2"></i>Activity
              </Link>
              <Link to="/cards" className="sidebar-btn-link">
                <i className="bi bi-card-text me-2"></i>Card
              </Link>
              <Link to="/settingpage" className="sidebar-btn-link">
          ...
          <section>
            ...
            <div className="d-flex flex-column gap-1 ps-4">
              <Link to="/boards" className="sidebar-btn-link active">
                <i className="bi bi-kanban me-2"></i>Boards
              </Link>
              <Link to="/members" className="sidebar-btn-link">
                <i className="bi bi-people me-2"></i>Members
              </Link>
              <Link to="/settings" className="sidebar-btn-link">
                <i className="bi bi-gear me-2"></i>Settings
              </Link>
            </div>
          </section>
                ...
                <Dropdown.Menu>
                  ...
                  >
                    ...
                    <div className="visibility-text">
                      ...
                      <span className="vis-desc">
                        Board members and Workspace admin can see and edit this
                        board.
                      </span>
                    </div>
                  </Dropdown.Item>
                  ...
                  >
                    ...
                    <div className="visibility-text">
                      ...
                      <span className="vis-desc">
                        Anyone on the workspace can see this board. Only board
                        members can edit.
                      </span>
                    </div>
                  </Dropdown.Item>

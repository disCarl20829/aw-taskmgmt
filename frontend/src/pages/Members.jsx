...
const Members = () => {
  ...
  return (
    <>
      <style>{`
        .mbr-root { background-color: #1d2125; min-height: 100vh; display: flex; color: #fff; }
        ...
        .tab-item {
          background: none; border: none; color: #9fadbc; padding: 8px 12px;
          border-radius: 4px; font-size: 0.9rem; width: 100%; text-align: left; cursor: pointer;
        }
      ...
      <div className="mbr-root">
        ...
        {/* ── MAIN ── */}
        <main style={{ flexGrow: 1, padding: "24px", overflowY: "auto", maxHeight: "100vh" }}>

          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
            <h5 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#fff", margin: 0 }}>Collaborators (1)</h5>
            <button style={{ backgroundColor: "#579dff", border: "none", color: "#fff", fontSize: "0.85rem", fontWeight: 500, padding: "6px 14px", borderRadius: "4px", cursor: "pointer" }}>
          ...
          <div style={{ display: "flex", gap: "24px" }}>
            ...
            <div style={{ width: "220px", minWidth: "220px", borderRight: "1px solid rgba(108,117,125,0.25)", paddingRight: "16px" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                <button className={`tab-item ${activeTab === "guests" ? "active" : ""}`} onClick={() => setActiveTab("guests")}>
                  Guests (0)
                </button>
                <button className={`tab-item ${activeTab === "requests" ? "active" : ""}`} onClick={() => setActiveTab("requests")}>
                  Join requests (0)
                </button>
              </div>
            </div>
            ...
            <div style={{ flexGrow: 1 }}>
              ...
              {activeTab === "members" && (
                <div>
                  ...
                  {/* Member row */}
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 0", borderTop: "1px solid rgba(108,117,125,0.25)", borderBottom: "1px solid rgba(108,117,125,0.25)", position: "relative" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", position: "relative" }}>
                      <button className="btn-secondary-custom" onClick={() => setShowBoardsPopover(!showBoardsPopover)}>
                        View boards (2)
                      </button>
                      {showBoardsPopover && (
                      ...
                      <button className="btn-secondary-custom" onClick={() => setShowAdminPopover(!showAdminPopover)}>
                        Admin ▾
                      </button>
                      {showAdminPopover && (
                        <div style={{ position: "absolute", backgroundColor: "#282e33", border: "1px solid #3d444d", borderRadius: "8px", width: "300px", zIndex: 1001, right: "100px", top: "-120px", overflow: "hidden" }}>
                          ...
                          <div style={{ padding: "12px 16px", backgroundColor: "rgba(255,255,255,0.04)" }}>
                            <p style={{ fontSize: "0.85rem", color: "#9fadbc", margin: 0 }}>
                      ...
                      <button className="btn-secondary-custom" onClick={() => setShowLeavePopover(!showLeavePopover)}>
                        Leave... ✕
                      </button>
                      {showLeavePopover && (
              ...
              {activeTab === "guests" && (
                <div>
                  ...
                  <hr style={{ borderColor: "rgba(108,117,125,0.25)", marginBottom: "20px" }} />
                  <p style={{ color: "#9fadbc", fontSize: "0.85rem", textAlign: "center", marginTop: "48px", fontStyle: "italic" }}>
              ...
              {activeTab === "requests" && (
                <div>
                  ...
                  <hr style={{ borderColor: "rgba(108,117,125,0.25)", marginBottom: "20px" }} />
                  <p style={{ color: "#9fadbc", fontSize: "0.85rem", textAlign: "center", marginBottom: "20px" }}>

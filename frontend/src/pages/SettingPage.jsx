        ...
        <nav className="sidebar p-3 border-end border-secondary border-opacity-25">
          <section className="mb-4">
            ...
            <div className="d-flex flex-column gap-1 mt-3">
                         ...
                         <Link to="/settingpage" className="sidebar-btn-link active text-decoration-none">
              ...
              <div className="mb-2">
                ...
                <div className="ps-4">
                  ...
                  <div className="ps-3 mb-5">
                    ...
                    <label className="d-block small fw-bold mb-2">Frequency</label>
                    <select
                    ...
                    {frequency === "Never" ? (
                      <div className="info-box-disabled p-4 rounded-1">
                        ...
                        <p className="text-muted-custom small mb-3">
                          You won't get any notifications sent to your email inbox.
                        </p>
                      ...
                      <div>
                        ...
                        {[
                          { title: "Comments", desc: "New comments added on cards you're watching" },
                          { title: "Due dates", desc: "Due dates are added, changed, or approaching on a card you're watching" },
                          { title: "You're removed from a card", desc: "Someone removes you as a member from a card" },
                          { title: "Attachments added", desc: "Files or links added to cards you're watching" },
                          { title: "Cards created", desc: "New cards created on boards you're watching" },
                          { title: "Cards moved", desc: "Cards you're watching are moved between lists or boards" },
                          { title: "Cards archived", desc: "Cards you're watching are archived (or unarchived)" },
                        ].map((item, idx) => (

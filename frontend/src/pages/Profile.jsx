  ...
  return (
    <>
      ...
      <div className="container-fluid p-0 d-flex bg-dark-main text-light vh-100">
        ...
        <nav className="sidebar p-3 border-end border-secondary border-opacity-25">
          <section className="mb-4">
            ...
            <div className="d-flex flex-column gap-1 mt-3">
                                     <Link to="/profile" className="sidebar-btn-link active text-decoration-none">
        ...
        <div className="flex-grow-1 position-relative" style={{ display: "flex", flexDirection: "column", height: "100vh", overflow: "hidden" }}>
